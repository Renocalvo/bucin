  ...
  function sbakhir(){Bn.style.display="none";tmbl.innerHTML="💌 Balas";Tombol.style="text-align : center; margin-top:10px; opacity:1;transform: scale(1); ";ftom=5;fungsi=0;}
